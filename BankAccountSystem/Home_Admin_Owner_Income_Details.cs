...
{
    public partial class Home_Admin_Owner_Income_Details : Form
    {
        public Home_Admin_Owner_Income_Details()
        {
            InitializeComponent();
        }
        ...
        private void Print_Document_MouseMove(object sender, MouseEventArgs e)
        {
